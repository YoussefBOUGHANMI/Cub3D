...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/03/18 14:54:13 by pschemit          #+#    #+#             */
/*   Updated: 2023/03/25 14:12:30 by yboughan         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	ft_manage_pj(t_cub3d *data)
{
	...
	{
		if (a == -1)
			printf("Error\n parsing : Double position joueur\n");
		if (a == -2)
			printf("Error\n parsing : Map error or double map\n");
		if (a == -3)
			printf("Error\n parsing : Joueur hors zone\n");
		if (a == -4)
			printf("Error\n parsing : Position joueur manquant\n");
		return (-1);
	}
	return (a);
}
